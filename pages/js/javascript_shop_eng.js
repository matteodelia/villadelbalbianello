...
function parallax_effect_events() {
  $(window).scroll(function(){
    var scrollval = $(this).scrollTop();

    $(".body_moving").css("transform",'translate(0,-'+scrollval/30+'%)');
    $(".overview, .loggia_durini, .loggia_segrè").css("transform",'translate(0,calc(-50% - '+scrollval/10+'%))');
    $(".terrazza_a_lago, .terrazza_canfora").css("transform",'translate(-100%,calc(-50% - '+scrollval/10+'%))');
  });
}
